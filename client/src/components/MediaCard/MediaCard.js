...
function MediaCard(props) {
  ...
  return (
    //getbuildinfo order or props matters*
      ...
      <Card className={classes.card} id="build-image-card" onClick={() => props.getBuildInfo(props.description, props.buildURL, props.spacingForBuild, props.last_name, props.first_name, props.technologies_used)}>
